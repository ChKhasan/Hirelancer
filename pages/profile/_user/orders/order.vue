  ...
  <div class="pt-12 order lg:bg-red">
    <div class="max-w-[1286px] mx-auto pb-[55px]">
      ...
      <div class="content-box mt-6">
        <div class="rounded-3xl border-solid border-grey-8 border relative">
          <div
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            ...
            <div class="buttons flex flex-col gap-4">
              <button
                @click="openModal"
                class="h-[52px] justify-center flex items-center gap-2 rounded-[8px] border border-solid bg-light-red border-light-red text-base text-white font-medium"
              >
                Отменить заказ
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                class="h-[52px] justify-center flex items-center gap-2 rounded-[8px] border border-solid bg-white border-brown text-base text-light-red font-medium"
              >
                Жалоба<svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
