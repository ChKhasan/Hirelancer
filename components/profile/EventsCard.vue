<template lang="html">
  <div
    class="events-card border border-solid border-grey-8 rounded-[12px] px-4 py-4 card cursor-pointer"
  >
    <div class="body flex flex-col justify-between">
      ...
      <p class="text-grey-40 text-[14px] font-medium flex gap-2 items-center">
        <svg
    ...
    <div class="image h-[216px] rounded-[6px] overflow-hidden">
      <img
