  ...
  <path d="M9 11.6527L10.0962 12.8303C10.4044 13.087 10.8833 13.0477 11.1379 12.7448L14 10" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div class="body flex flex-col justify-center">
      <div class="flex justify-between mb-[2px] xl:mb-[6px] xl:relative">
        ...
        >
          <path
            d="M7.19907 6.07751H13.9324V12.81M6.0874 13.9225L13.9224 6.08751"
            stroke="#5C46E6"
            stroke-width="1.5"
