    ...
    <div class="max-w-[1200px] mx-auto pt-[48px] grid-container h-full">
      ...
      <div class="form flex flex-col gap-[26px] relative">
        ...
        <div class="buttons flex gap-4">
          <button
            class="px-[24px] items-center border border-solid rounded-[8px] h-[52px] border-grey-24 flex justify-center text-base text-grey-64 font-medium"
          >
            Отмена
          </button>
          <button
            @click="submitForm"
            class="px-[24px] gap-2 items-center border border-solid rounded-[8px] h-[52px] border-blue bg-blue flex justify-center text-base text-white font-medium"
          >
            Отправить заявку
            <svg
        ...
        <button class="absolute top-0 right-[-80px]" @click="$emit('close')">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="40"
            height="40"
