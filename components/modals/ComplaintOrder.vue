<template lang="html">
      ...
      <div class="flex flex-col gap-6 pl-4">
       ...
       <div class="flex flex-col gap-4">
        <a-form-model :model="form" ref="ruleForm" :rules="rules">
          <a-form-model-item prop="deadline" class="form-item w-full mb-0">
            <a-input
              v-model="text"
              type="textarea"
              rows="6"
  ...
  <path d="M9.56495 11.757L11.938 14.129L16.195 9.87098M20.498 11.999C20.498 16.4161 16.9171 19.997 12.5 19.997C8.08278 19.997 4.50195 16.4161 4.50195 11.999C4.50195 7.5818 8.08278 4.00098 12.5 4.00098C16.9171 4.00098 20.498 7.5818 20.498 11.999Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
          </button>
        </div>
       </div>
